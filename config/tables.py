...
financial_analysis = {
    ...
    # The specific type of analysis being recorded (e.g., 'profit', 'expenses', 'salaries').
    "analysis_type": "TEXT NOT NULL",
    # The final calculated value of the analysis.
    "final_value": "REAL NOT NULL",
    # Details of the analysis period.
    "period_type": "TEXT NOT NULL",  # نوع الفترة (مثال: 'daily', 'monthly', 'quarterly').
    "start_date": "DATETIME NOT NULL",  # بداية الفترة الزمنية.
    "end_date": "DATETIME NOT NULL",  # نهاية الفترة الزمنية.
    # The date and time the analysis was generated.
    "generated_at": "DATETIME NOT NULL",
}
course_analytics = {
    "id": "INTEGER PRIMARY KEY AUTOINCREMENT",
    "course_id": "INTEGER NOT NULL",
    "metric_type": "TEXT NOT NULL",  # نوع المقياس (مثال: 'passing_rate')
    "value": "REAL NOT NULL",  # قيمة المقياس
    "start_date": "DATETIME NOT NULL",  # بداية الفترة الزمنية للتحليل
    "end_date": "DATETIME NOT NULL",  # نهاية الفترة الزمنية للتحليل
    "generated_at": "DATETIME NOT NULL",  # تاريخ ووقت إنشاء هذا التحليل
    "FOREIGN KEY": "(course_id) REFERENCES courses(id)",
}
classroom_analytics = {
    "id": "INTEGER PRIMARY KEY AUTOINCREMENT",
    "classroom_id": "INTEGER NOT NULL",
    "metric_type": "TEXT NOT NULL",  # نوع المقياس (مثال: 'utilization_rate', 'number_of_sessions')
    "value": "REAL NOT NULL",  # قيمة المقياس
    "start_date": "DATETIME NOT NULL",  # بداية الفترة الزمنية للتحليل
    "end_date": "DATETIME NOT NULL",  # نهاية الفترة الزمنية للتحليل
    "generated_at": "DATETIME NOT NULL",  # تاريخ ووقت إنشاء هذا التحليل
...
attendance_analytics = {
    ...
    "metric_type": "TEXT NOT NULL",  # نوع المقياس (مثال: 'attendance_rate', 'late_count')
    "value": "REAL NOT NULL",  # قيمة المقياس
    "start_date": "DATETIME NOT NULL",  # بداية الفترة الزمنية للتحليل
    "end_date": "DATETIME NOT NULL",  # نهاية الفترة الزمنية للتحليل
    "generated_at": "DATETIME NOT NULL",  # تاريخ ووقت إنشاء هذا التحليل
